...
@implementation BallSizeChartViewController
...
- (id)init
{
    ...
    if (self) {
        ...
        self.chartView = [[AcornBallSizeChartView alloc] initWithFrame:CGRectMake(([self.view bounds].size.width-width)/2, ([self.view bounds].size.height-height)/2, width, height)];
